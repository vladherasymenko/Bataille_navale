...
public class Game {
	...
	public Game init() {
		if (!loadSave()) {
			...
			BattleShipsAI AI1 = new BattleShipsAI(boardPlayer1,boardPlayer2);
			BattleShipsAI AI2 = new BattleShipsAI(boardPlayer2,boardPlayer1);
			// TODO place player ships
			AbstractShip[] shipsPlayer1 = createDefaultShips();
			AI1.putShips(shipsPlayer1);
			AbstractShip[] shipsPlayer2 = createDefaultShips();
			AI2.putShips(shipsPlayer2);
			
			boardPlayer1.print();
			
			/*
			Game.addShip('C',"Porte-avion", boardPlayer1);
			boardPlayer1.print();
			
			Game.addShip('B', "Croiseur", boardPlayer1);
			boardPlayer1.print();
			Game.addShip('D', "Destroyer", boardPlayer1);
			boardPlayer1.print();
			Game.addShip('S', "Sous-marin1", boardPlayer1);
			boardPlayer1.print();
			Game.addShip('S', "Sous-marin2", boardPlayer1);
			boardPlayer1.print();
			
			
			boardPlayer1.sendHit(new Coords(0, 0));
			boardPlayer1.sendHit(new Coords(0, 1));
			boardPlayer1.sendHit(new Coords(0, 2));
			boardPlayer1.sendHit(new Coords(0, 3));
			boardPlayer1.sendHit(new Coords(0, 4));
			boardPlayer1.sendHit(new Coords(0, 5));
			boardPlayer1.print();
			*/
			System.out.println("Les navires ont été placés. À vos postes !");
